...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Akos\PhpstormProjects\verseny\verseny\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Akos\\PhpstormProjects\\verseny\\verseny\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'home','login','logout','register','password.request','password.email',
'password.reset','password.update','password.confirm','users.list',
'verseny.store','verseny.show','verseny.list','verseny.addParticipant','verseny.listParticipant',
'verseny.delete','verseny.edit','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','home','layouts.app','verseny.list','verseny.show',
